      ...
      <section v-else-if="currentStep === 'storing'" class="step-content">
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div class="px-6 py-6">
            ...
            <div class="mb-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800"><strong>Taxa de {{ formatCents(lockerHourlyRate) }}/hora</strong> — cobrança por hora iniciada. Retire seus itens quando quiser.</div>
