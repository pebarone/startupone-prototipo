    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-16 bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl px-8 py-10 text-center shadow-xl overflow-hidden relative">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
          ...
          <a href="#" class="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-white/10 px-6 text-sm font-semibold text-white transition-transform duration-150 hover:bg-white/15 hover:scale-[0.98] active:scale-95 border border-white/10 backdrop-blur-sm">
...
function isFaqOpen(categoryTitle, index) {
  return openFaqs.value.has(`${categoryTitle}-${index}`)
}
</script>
